...
namespace Caliburn.Micro.WinRT.Autofac.StorageHandlers {
    ...
    public static class StorageInstructionExtensions {
        /// <summary>
        /// Stores the data in the transient State.
        /// </summary>
        /// <typeparam name="T">The model type.</typeparam>
        /// <param name="builder">The builder.</param>
        /// <returns>The builder.</returns>
        public static StorageInstructionBuilder<T> InLocalStorage<T>(this StorageInstructionBuilder<T> builder) {
            return builder.Configure(x => { x.StorageMechanism = x.Owner.Coordinator.GetStorageMechanism<WinRTLocalStorageMechanism>(); });
        }
